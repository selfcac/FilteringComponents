...
namespace ProcessTerminationProtection
{
...
uint nLength, out uint lpnLengthNeeded);
        ...
        public static void ProtectCurrentProcess(WellKnownSidType sid = WellKnownSidType.WorldSid)
        {
            ProtectProcess(GetCurrentProcess(),sid);
        }

        public static void ProtectProcessByID(int processID, WellKnownSidType sid = WellKnownSidType.WorldSid)
        {
            try
            {
                Process p = Process.GetProcessById(processID);
                if (p != null)
                    ProtectProcess(p.Handle, sid);
            }
            catch (Exception ex)
            {
        ...
        public static void ProtectCurrentFromUsers()
        {
            ProtectProcess(GetCurrentProcess(),WellKnownSidType.BuiltinUsersSid);
        }

        public static void ProtectFromUsersByID(int processID)
        {
            ProtectProcessByID(processID, WellKnownSidType.BuiltinUsersSid);
        }
    }
}
